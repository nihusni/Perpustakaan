        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                <div class="title">
                  <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Borrow Book</strong>
                </div>
          ...
          <div class="col-lg-6">
            <div class="stats-2-block block d-flex">
              <div class="stats-2 d-flex">
                ...
                <div class="stats-2-content"><strong class="d-block">5.657</strong><span class="d-block">Library Fund Expenditures</span>
              ...
              <div class="stats-2 d-flex">
                ...
                <div class="stats-2-content"><strong class="d-block">3.1459</strong><span class="d-block">Library Fund Income</span>
                  <div class="progress progress-template progress-small">
            ...
            <div class="stats-3-block block d-flex">
              <div class="stats-3"><strong class="d-block">568</strong><span class="d-block">Visitor Request</span>
                <div class="progress progress-template progress-small">
