...
class AdminController extends Controller
{
    public function index()
    {
...

        {
...

            {
                ...
                return view('admin.index',compact('user','books','borrow','returned'));
    ...
    public function bookshelve_page()
    {
        $bookshelves = Bookshelve::all();

        return view('admin.bookshelve',compact('bookshelves'));
    }




    public function add_bookshelve(Request $request)
    {
        $bookshelves = new Bookshelve;

        $bookshelves->name = $request->bookshelve;

        $bookshelves->save();

        return redirect()->back()->with('message','Bookshelve Added Successfully');

    }



    public function shelve_delete($id)
    {

        $bookshelves= Bookshelve::find($id);

        $bookshelves->delete();

        return redirect()->back()->with('message','Bookshelve delete Successfully');
    ...
    public function add_book()
    {
        ...
        return view('admin.add_book',compact(['books', 'categories','bookshelves' ]));
    }
    ...
    public function store_book(Request $request)
    {
        ...
        $book->bookshelve_id = $request->bookshelve;
...

        {
            ...
            $book->auther_img = $auther_image_name;
        }
    ...
    public function show_book()
    {
        ...
        return view('admin.show_book',compact(['books', 'categories', 'bookshelves' ]));
